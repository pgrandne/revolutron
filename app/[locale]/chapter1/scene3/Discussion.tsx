                    ...
                    <div className="relative flex flex-col px-3 py-2 m-auto">
                        {stage < 3 &&
                            <>
                                ...
                                <ExternalDiscussion text={t('dialogue.d8')} name="Rob" nbCharPrevDisc={t('dialogue.d7').length} delay={6} />
                                <ExternalDiscussion text={t('dialogue.d9')} name="Jessy" nbCharPrevDisc={t('dialogue.d7').length + t('dialogue.d8').length} delay={6} />
                                {stage > 0 && <>
