                    ...
                    <div className="relative flex flex-col px-3 py-2 m-auto">
                        ...
                        {stage > 7 &&
                            <>
                                ...
                                <ExternalDiscussion text={t('dialogue.d9')} telegramWindow={true} nbFollowingDialogue={2} />
                            </>
                        }
                        {stage > 8 &&
                            <>
                        ...
                        {stage > 9 &&
                            <>
                                ...
                                <ExternalDiscussion text={t('dialogue.d12')} telegramWindow={true} nbFollowingDialogue={2} />
                            </>
                        }
                        <div id="end" />
                    </div>
