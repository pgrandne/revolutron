        ...
        <div className="flex w-full h-full">
            <div className="relative flex flex-col flex-1">
                <div className="self-center flex-1 w-full max-w-xl overflow-auto">
                    <div className="relative flex flex-col px-3 py-2 m-auto">
                        ...
                        {stage > 2 && <>
                            ...
                            <ExternalDiscussion text={t('dialogue.d6')} nbCharPrevDisc={t('dialogue.d5').length} nbFollowingDialogue={2} />
                        </>}
                        {stage > 3 && <>
                            <AzadDiscussion azadText={azadText[3]} />
                            <ExternalDiscussion text={t('dialogue.d7')} />
                            <ExternalDiscussion text={t('dialogue.d8')} nbCharPrevDisc={t('dialogue.d7').length} nbFollowingDialogue={2} />
                            <ExternalDiscussion text={t('dialogue.d9')} nbCharPrevDisc={t('dialogue.d7').length + t('dialogue.d8').length} nbFollowingDialogue={3} />
                        </>}
                        {stage > 4 && <>
                            <AzadDiscussion azadText={azadText[4]} />
                            <ExternalDiscussion text={t('dialogue.d11')} />
                        </>}
                        {stage > 5 && <>
                            <AzadDiscussion azadText={azadText[5]} />
                            <ExternalDiscussion text={t('dialogue.d12')} />
                            <ExternalDiscussion text={t('dialogue.d13')} nbCharPrevDisc={t('dialogue.d12').length} nbFollowingDialogue={2} />
                            <ExternalDiscussion text={t('dialogue.d14')} nbCharPrevDisc={t('dialogue.d12').length + t('dialogue.d13').length} nbFollowingDialogue={3} />
                            <ExternalDiscussion text={t('dialogue.d15')} nbCharPrevDisc={t('dialogue.d12').length + t('dialogue.d13').length + t('dialogue.d14').length} nbFollowingDialogue={4} />
                        </>}
                        {stage > 6 && <>
                            <AzadDiscussion azadText={azadText[6]} />
                            <ExternalDiscussion text={t('dialogue.d16')} />
                            <ExternalDiscussion text={t('dialogue.d17')} nbCharPrevDisc={t('dialogue.d16').length} nbFollowingDialogue={2} />
                            <ExternalDiscussion text={t('dialogue.d18')} nbCharPrevDisc={t('dialogue.d16').length + t('dialogue.d17').length} nbFollowingDialogue={3} />
                        </>}
                        {stage > 7 && <>
                ...
                >
                    ...
                    {stage === 5 &&
                        <AzadChoices stage={stage} setStage={setStage} azadText={azadText} setAzadText={setAzadText} choice1={t('choices.c6.choice1')} choice2={t('choices.c6.choice2')} nbCharPrevDisc={t('dialogue.d10').length + t('dialogue.d11').length} delay={0.5} />
                    }
                    {stage === 6 &&
